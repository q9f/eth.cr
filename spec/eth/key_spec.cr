...
describe Key do
  it "can create random key-pairs out of thin air" do
    10.times do
      ...
      rand.address.to_s.size.should eq 42
    end
  end
  ...
  it "generates valid key-pairs from private key" do
    ...
    key.address.to_s.should eq "0x9f62D99C36Af327A84E3Fd29091e5bd4edf29609"
    ...
    kez.address.to_s.should eq "0x27Fa698BFD3fDB21a17760a139b604BcFc6427CC"
  end

  it "can generate valid ethereum addresses" do
    prv = Num.new "d6c8ace470ab0ce03125cac6abf2779c199d21a47d3e75e93c212b1ec23cfe51"
    key = Key.new prv
    key.address.to_s.should eq "0x2Ef1f605AF5d03874eE88773f41c1382ac71C239"
  end
end
